      ...
      <div className=" gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8 ">
        <div className=" flex items-center justify-between py-5 md:block ">
          ...
          <div className="md:hidden">
            <button className=" text-gray-500 hover:text-gray-800" onClick={()=> setShow(!show)}>
        ...
        <ul className="md:flex md:space-x-6">
            {
                navigation.map(item=>(
                    ...
                    text-gray-700 font-medium flex justify-center">
                        <NavLink to={item.path} className=" block hover:bg-main rounded-full py-2 px-4 hover:text-white "> {item.title}</NavLink>
                    </li>
                ))
            }
        </ul>
